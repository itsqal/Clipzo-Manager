<div class="bg-white rounded-xl shadow-md border border-gray-200">
    <div class="p-4 border-b border-gray-200 shrink-0 flex justify-between items-center">
        <h3 class="text-base font-semibold text-clipzo-dark">Produk Terpopuler</h3>
...
<script>
    ...
    function initProductsChart() {
        ...
        console.log('Product chart initialized successfully');
    }
    ...
    $wire.$watch('chartData', () => {
        ...
        setTimeout(() => initProductsChart(), 100);
    });
</script>
@endscript
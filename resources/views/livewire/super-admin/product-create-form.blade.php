<div class="bg-white rounded-xl shadow-md border border-gray-200 flex flex-col min-h-0 p-3 md:p-4 max-h-[65vh] md:max-h-none">
    <h3 class="font-semibold text-clipzo-dark mb-2 md:mb-3 md:text-base text-sm shrink-0">Tambah Produk Baru</h3>

    <form wire:submit.prevent="save" class="space-y-3 flex-grow overflow-auto min-h-0">
        <div>
            <label class="text-xs md:text-sm font-medium text-gray-700 mb-1 block">Nama Produk</label>
            <input type="text"
                   wire:model.defer="name"
                   placeholder="Contoh: Hair Pomade"

    ...
    <div class="flex flex-col h-[calc(100vh-3rem)]"> 
        ...
        <div class="flex-grow min-h-0 flex flex-col">
            <div class="flex justify-between items-center mb-4 shrink-0">
                <h2 class="text-xl font-semibold text-clipzo-dark">Manajemen Produk</h2>
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-12 gap-4 flex-grow min-h-0">
                ...
                <!-- Table Widget -->
                <livewire:super-admin.product-table />

                <!-- Chart Widget -->
                <livewire:super-admin.product-chart />
                </div>
                ...
                <div class="md:col-span-4 col-span-1 flex flex-col space-y-4 min-h-full">
                    <!-- Add Product Form -->
                    <div>
                        <livewire:super-admin.product-create-form />
                    </div>
                    
                    <div>
                        <livewire:super-admin.product-stats />
                    </div>
                </div>
